    ...
    public static void main(String[] args) throws IOException {
        ...
        try(RandomAccessFile rao = new RandomAccessFile("locations_rand.dat", "rwd")){
            ...
            for (Integer locationID : index.keySet()) {
                ...
                rao.writeInt(index.get(locationID).getStart());
...
*/
        try {
            ...
            long locationsStart = raf.readInt();

            while (raf.getFilePointer() < locationsStart) {
            ...
            System.out.println("IO Exception found" + io.getMessage());
        }
    }

    public Location getLocation(Integer locationID) throws IOException {

        IndexRecord record = index.get(locationID);
        raf.seek(record.getStart());
        raf.readInt();
        String description = raf.readUTF();
        String[] exitsPart = (raf.readUTF()).split(",");
